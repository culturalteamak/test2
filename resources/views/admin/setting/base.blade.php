                                    ...
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <select id="smtpmode" name="smtpmode" lay-verify="required" lay-filter="risk_mode">
                                                <option @if(isset($setting['smtpmode'])&&$setting['smtpmode']=='1'){{'selected' ?? ''}}@endif value="1">Protonmail</option>
                                                <option @if(isset($setting['smtpmode'])&&$setting['smtpmode']=='2'){{'selected' ?? ''}}@endif value="2">其他</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="layui-inline">
