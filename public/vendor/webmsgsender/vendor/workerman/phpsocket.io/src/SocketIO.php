...
if($port)
        {
        	$opts['ssl'] = array(
		        'local_cert'  => '/www/server/panel/vhost/cert/jys110.bygoukai.com/fullchain.pem',  //您的证书所存放的位置
		        'local_pk'    => '/www/server/panel/vhost/cert/jys110.bygoukai.com/privkey.pem',
		        'verify_peer' => false,
	    	);
