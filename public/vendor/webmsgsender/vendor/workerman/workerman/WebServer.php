...
class WebServer extends Worker
{
    ...
    public static function sendFile($connection, $file_path)
    {
       ...
       $header .= "Content-Length: $file_size\r\n\r\n";
        ...
        $header .= "Access-Control-Allow-Headers:Origin, X-Requested-With, Content-Type, Accept, WG-App-Version, WG-Device-Id, WG-Network-Type, WG-Vendor, WG-OS-Type, WG-OS-Version, WG-Device-Model, WG-CPU, WG-Sid, WG-App-Id, WG-Token\r\n\r\n";
