                    ...
                    <div class="layui-input-block">
                        <select id="currency" class="layui-input" name="currency" >
                            <?php $__currentLoopData = $currencys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($currency['currency_name']); ?>" <?php echo e(($data?$data->base:'IEPN')==$currency['currency_name']?'selected':''); ?>> <?php echo e($currency['currency_name']); ?></option>
        ...
        <div class="layui-row">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input itime" id="dates" name="dates" lay-verify="required"
                               placeholder="请选择时间" value="<?php echo e($data?substr($data->itime,0,16):date('Y-m-d H:i')); ?>"
                               type="text">
                    </div>
                </div>
            </div>
            <div class="layui-col-md4 layui-col-xs4  layui-col-md4">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="insert_range" class="layui-input">
                            <option value="1">
                                1分钟
                            </option>
                            <option value="5">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input" id="start" name="start" lay-verify="required" placeholder="起始价格"
                               value="<?php echo e($data?$data->close:1.2132); ?>" type="text">
                    </div>
                </div>
            </div>
