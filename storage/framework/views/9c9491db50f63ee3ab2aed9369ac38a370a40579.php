        ...
        <form class="layui-form col-lg-5">
            <div class="layui-tab">
                ...
                <div class="layui-tab-content">
                                ...
                                <div class="layui-form-item ecology">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <select id="smtpmode" name="smtpmode" lay-verify="required" lay-filter="risk_mode">
                                                <option <?php if(isset($setting['smtpmode'])&&$setting['smtpmode']=='1'): ?><?php echo e('selected' ?? ''); ?><?php endif; ?> value="1">Protonmail</option>
                                                <option <?php if(isset($setting['smtpmode'])&&$setting['smtpmode']=='2'): ?><?php echo e('selected' ?? ''); ?><?php endif; ?> value="2">其他</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                    ...
                    <!--通证设置开始-->
                    <div class="layui-tab-item" hidden>
                        <div class="layui-form-item">
